...
<head>
    ...
    <title>PMURAS - Admin Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        /* ✅ ADDED: Content wrapper to push button to bottom */
        .card-content {
            flex: 1;
            display: flex;
            flex-direction: column;
        ...
        /* ✅ IMPROVED: Endorsement list styling */
        .endorsement-list {
            list-style: none;
            margin: 15px 0;
        }
...
<!-- ── LOGO HEADER ── -->
    ...
    <div class="container">
        ...
        <!-- ✅ ADDED: Welcome Box with User Info -->
        ...
        <div class="dashboard-grid">
            <!-- Card 1: PMURAS Recognition & Achievement -->
            ...
            <!-- Card 3: Endorsement -->
            <div class="dashboard-card">
                <h2>PMURAS<br>ENDORSEMENT</h2>
                <div class="card-content">
                    <ul class="endorsement-list">
                        <li>Manage submission for staff recognition and achievement</li>
                        <li>User Management</li>
                        <li>Reports</li>
                    </ul>
                    <a href="admin_interface.php?page=manage_submission" class="btn-enter">≫ Endorse Submissions</a>
                </div>
            </div>
